...
int main(int argc, char *argv[]) {
    ...
    for ( int idx = 0; idx < 64; idx++ ) {
        ...
        hist_C.push_back(new TH1F((TString)(branchName_C), ";IntADC;nEvents", 1000, -5000., 5000.));
        hist_S.push_back(new TH1F((TString)(branchName_S), ";IntADC;nEvents", 1000, -5000., 5000.));
    }
