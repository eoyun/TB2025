...
int main(int argc, char *argv[]) {
    ...
    for (int iEvt = 0; iEvt < fMaxEvent; iEvt++) {
        ...
        for(int tower = 0; tower < 4; tower++) {
            wave_M1_C.emplace_back( anEvt.GetData(cid_M1_C.at(tower)).ADCpedcorrectedWaveformF() ); 
            wave_M2_C.emplace_back( anEvt.GetData(cid_M2_C.at(tower)).ADCpedcorrectedWaveformF() ); 
            wave_M3_C.emplace_back( anEvt.GetData(cid_M3_C.at(tower)).ADCpedcorrectedWaveformF() ); 
            wave_M4_C.emplace_back( anEvt.GetData(cid_M4_C.at(tower)).ADCpedcorrectedWaveformF() ); 
            wave_M5_C.emplace_back( anEvt.GetData(cid_M5_C.at(tower)).ADCpedcorrectedWaveformF() ); 
            wave_M6_C.emplace_back( anEvt.GetData(cid_M6_C.at(tower)).ADCpedcorrectedWaveformF() ); 
            wave_M7_C.emplace_back( anEvt.GetData(cid_M7_C.at(tower)).ADCpedcorrectedWaveformF() ); 
            wave_M8_C.emplace_back( anEvt.GetData(cid_M8_C.at(tower)).ADCpedcorrectedWaveformF() ); 
            wave_M9_C.emplace_back( anEvt.GetData(cid_M9_C.at(tower)).ADCpedcorrectedWaveformF() ); 
            
            wave_M1_S.emplace_back( anEvt.GetData(cid_M1_S.at(tower)).ADCpedcorrectedWaveformF() ); 
            wave_M2_S.emplace_back( anEvt.GetData(cid_M2_S.at(tower)).ADCpedcorrectedWaveformF() ); 
            wave_M3_S.emplace_back( anEvt.GetData(cid_M3_S.at(tower)).ADCpedcorrectedWaveformF() ); 
            wave_M4_S.emplace_back( anEvt.GetData(cid_M4_S.at(tower)).ADCpedcorrectedWaveformF() ); 
            wave_M5_S.emplace_back( anEvt.GetData(cid_M5_S.at(tower)).ADCpedcorrectedWaveformF() ); 
            wave_M6_S.emplace_back( anEvt.GetData(cid_M6_S.at(tower)).ADCpedcorrectedWaveformF() ); 
            wave_M7_S.emplace_back( anEvt.GetData(cid_M7_S.at(tower)).ADCpedcorrectedWaveformF() ); 
            wave_M8_S.emplace_back( anEvt.GetData(cid_M8_S.at(tower)).ADCpedcorrectedWaveformF() ); 
            wave_M9_S.emplace_back( anEvt.GetData(cid_M9_S.at(tower)).ADCpedcorrectedWaveformF() ); 
        } 
    ...
    // Output file
    std::string outFile = "./Closure/Closure_Run_" + std::to_string(fRunNum) +"_" +correctionMode +".root";
